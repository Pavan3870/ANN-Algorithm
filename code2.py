...
dataset = pd.read_csv(r'C:\Users\Pavan\Desktop\Data Science Material\Data Science Notes-1\1.Notes\5.July_22\July-22\12th July\12th\ANN_ 1st\Churn_Modelling.csv')
X = dataset.iloc[:, 3:13]
y = dataset.iloc[:, 13]
